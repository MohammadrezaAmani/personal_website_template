  ...
  return (
    <section className="max-w-6xl mx-auto px-8 py-16">
      <div className="text-center mb-14">
        ...
        />
        <h1 className="text-4xl font-extrabold text-white">{about.name}</h1>
        <p className="text-lg text-gray-400 mt-2">{about.title}</p>
      ...
      <div className="mt-8 bg-gray-800 rounded-lg shadow-md p-8">
        <h2 className="text-2xl font-bold text-white mb-4">
          {t("about.interests")}
        </h2>
