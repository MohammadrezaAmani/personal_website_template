...
//           <p className="text-center text-gray-300">{t("common.noResults")}</p>
//         ) : (
//           filteredFAQs.map((item) => (
//             <Disclosure key={item.id}>
//               {({ open }) => (
//                 <div className="bg-gray-800 rounded-lg shadow-md">
//                   <Disclosure.Button className="w-full px-6 py-4 text-left focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-800 rounded-lg">
