    ...
    <div className="space-y-16 pb-16 mt-5">
      ...
      <section className="relative -mt-8 px-4 py-20 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-600 via-blue-500 to-indigo-600 rounded-xl">
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          <div className="relative inline-block">
            ...
            <img
              src={about.image || content.default_user_image}
              alt={about.name}
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-gray-800 rounded-2xl shadow-lg p-8 text-center transform hover:-translate-y-1 transition-transform">
            <Code className="h-10 w-10 text-blue-400 mx-auto mb-4" />
            <h3 className="text-2xl font-bold text-white mb-2">
              {projects.length}+ Projects
            </h3>
            <p className="text-gray-300">Completed & Ongoing</p>
          </div>
          <div className="bg-gray-800 rounded-2xl shadow-lg p-8 text-center transform hover:-translate-y-1 transition-transform">
            <Briefcase className="h-10 w-10 text-blue-400 mx-auto mb-4" />
            <h3 className="text-2xl font-bold text-white mb-2">8+ Years</h3>
          ...
          <div className="bg-gray-800 rounded-2xl shadow-lg p-8 text-center transform hover:-translate-y-1 transition-transform">
            ...
            <p className="text-gray-300">Written & Published</p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {projects.slice(0, 2).map((project) => (
            <div
              key={project.id}
              className="group bg-gray-800 rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow"
            >
              ...
              <div className="p-8">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.tags.map((tag) => (
                    <span
                      key={tag}
                      className="px-3 py-1 bg-blue-900/50 text-blue-400 rounded-full text-sm font-medium"
                    >
                      {tag}
                    </span>
                  ))}
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-10">
          <h2 className="text-3xl font-bold text-white">{t("blog.latest")}</h2>
          <Link
            to="/blog"
            className="text-blue-400 hover:text-blue-300 flex items-center"
          >
          ...
          {blog.slice(0, 2).map((post) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <h3 className="text-2xl font-bold text-white mb-3 group-hover:group-hover:text-blue-400 transition-colors">
                  {post.title}
                </h3>
